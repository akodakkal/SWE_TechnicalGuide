...
Follow [this example](SWE_TechnicalGuide/pages/Kratos/Workshops/Hitchhiker_Guide_SWE/Installation_Guides/Testing_Kratos_Installation.md) to see whether you have properly installed GiD and Kratos
