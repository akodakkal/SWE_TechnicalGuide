...
When located in the new website, download and extract **"ffmpeg-master-latest-win64-gpl.zip"**. After extracting the content of ffmpeg, rename it to FFmpeg. Save ffmpeg in a directory of your choice, for example under local disk C:\ .
